...
Vortex-DNA is an optional `SYM` architecture for identity continuity, memory organization, scientific classification, feedback routing, auditability and boundary protection. “DNA” is metaphorical unless a separate biological record supports a biological claim.
...
| `BOUNDARY_CORE` | Protection against accidental evidence/status mixing |
